...
api.add_resource(TeamAPI, '/api/v1.0/teams/<int:id>')
api.add_resource(PlayerAPI, '/api/v1.0/players/<int:id>')
api.add_resource(GameAPI, '/api/v1.0/games/<int:id>')